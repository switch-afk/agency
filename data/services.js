const services = [
  ...
  { id: 'social-kit', category: 'Branding & Identity', icon: '📱', name: 'Social Media Kit', description: 'Twitter/X banners, Discord server setup with roles and channels, Telegram group branding, and post templates.', price: 279, features: ['X/Twitter assets', 'Discord setup', 'TG branding', 'Post templates'] },
  ...
  // AI + Solana
  {
    ...
    description: 'Autonomous on-chain agents powered by Claude or ChatGPT with real Solana wallet execution. Agents can trade, analyze market data, respond to on-chain events, and execute transactions autonomously — no human in the loop.',
    price: 2799,
    features: ['Claude or ChatGPT', 'On-chain execution', 'Natural language ops', 'Custom persona']
  },
  {
    id: 'ai-trading-bot',
    category: 'AI + Solana',
    ...
    description: 'Signal detection with automated trade execution on Solana. Technical analysis and sentiment scoring powered by Claude or ChatGPT with configurable risk management and real-time DEX routing.',
    price: 3499,
    features: ['Claude or ChatGPT', 'TA + sentiment', 'Auto-execute', 'Risk management']
  },
  {
    id: 'openclaw-dev',
    category: 'AI + Solana',
    ...
    badge: 'HOT',
    description: 'Build and deploy custom OpenClaw agents on Solana. OpenClaw is the leading open-source autonomous AI agent framework with 247k+ GitHub stars. We build agents that manage Solana wallets, automate on-chain transactions via Jupiter and Raydium, monitor markets, execute trades, earn SOL, and interact via Telegram or WhatsApp — all self-hosted on your own hardware.',
    price: 3999,
    features: ['Solana wallet ops', 'Jupiter / Raydium', 'Telegram / WhatsApp', 'Self-hosted deploy']
  },
  {
    id: 'rwa-tokenization',
    category: 'AI + Solana',
    ...
    badge: 'HOT',
    description: 'Real-World Asset tokenization on Solana using ZK Compression. Compliance-layer architecture, asset registry, and investor dashboard.',
    price: 6999,
    features: ['ZK Compression', 'Compliance layer', 'Asset registry', 'Investor dashboard']
  },
  ...
  // Test Services
  {
    ...
    name: 'Test Payment ($5)',
    badge: 'TEST',
    description: 'End-to-end payment flow test. Sends $5 worth of SOL to the agency wallet via QuickNode RPC, creates a real order, and triggers the Discord bot announcement.',
    price: 5,
  ...
  },
  {
    ...
    badge: 'TEST',
    description: 'Zero-cost test order — bypasses payment entirely. Creates a full order record to test Discord notifications, dashboard tracking, admin status updates, and the complete order lifecycle.',
    price: 0,
